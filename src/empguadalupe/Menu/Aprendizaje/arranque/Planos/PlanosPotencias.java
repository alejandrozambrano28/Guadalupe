 ...
 * @author lzambrs
 */
public class PlanosPotencias extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanosPotencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
