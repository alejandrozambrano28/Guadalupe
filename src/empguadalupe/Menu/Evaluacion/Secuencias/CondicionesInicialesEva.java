...
//trae todos los textos de los labels
    ...
    public Boolean generarpreguntas(int pos) {
        ...
        if (selop[1] == pos || selop[2] == pos || selop[3] == pos) {
            ...
            int response = JOptionPane.showOptionDialog(null, "cual de las condiciones iniciales falta", "Pregunta",
    ...
    private void close() {
        JOptionPane.showMessageDialog(rootPane, "Falta completar las condiciones iniciales");
