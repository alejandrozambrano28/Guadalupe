...
public class PlanoS1evaPR extends javax.swing.JFrame implements ActionListener {
     ...
     */
    public PlanoS1evaPR(int numeroboton,int numentrada) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanoS1evaPR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
