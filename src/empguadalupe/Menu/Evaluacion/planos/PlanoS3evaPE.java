 ...
 * @author lzambrs
 */
public class PlanoS3evaPE extends javax.swing.JFrame {
  ...
  int nument=0;
     ...
     */
    public PlanoS3evaPE(int numeroboton,int numentrada) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(bomba2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 120, 50, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 20, 120, 110));
   ...
   if (bande4 == true) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanoS3evaPE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanoS3evaPE().setVisible(true);
            }
        });
    }
