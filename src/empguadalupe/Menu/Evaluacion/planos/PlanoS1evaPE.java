 ...
 * @author lzambrs
 */
public class PlanoS1evaPE extends javax.swing.JFrame implements ActionListener {
     ...
     */
    public PlanoS1evaPE(int numeroboton,int numentrada) {
        initComponents();
    ...
    private PlanoS1evaPE() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public PlanoS1evaPE(int i) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    private void btn18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn18ActionPerformed
        if (bande18 == true) {
            ParoEmergenciaEVA arra = new ParoEmergenciaEVA();
            arra.pu2[21+nument] = contErrores;
            arra.preguntas[21+nument] = 1;
            JOptionPane.showMessageDialog(rootPane, "correcto");
            dispose();
        } else {
    ...
    private void btn8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn8ActionPerformed
        if (bande8 == true) {
            ParoEmergenciaEVA arra = new ParoEmergenciaEVA();
            arra.pu2[29+nument] = contErrores;
            arra.preguntas[29+nument] = 1;
            JOptionPane.showMessageDialog(rootPane, "correcto");
            dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PlanoS1evaPE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PlanoS1evaPE().setVisible(true);
