 ...
 */
package empguadalupe.ParoEmergencia;


import empguadalupe.ParoEmergencia.*;
import empguadalupe.ParoEmergencia.*;

import empguadalupe.ParoEmergencia.Maquina.CerrarValvulaEsferica;
import empguadalupe.ParoEmergencia.Maquina.AplicarFrenosParoEmergencia;
import empguadalupe.ParoEmergencia.Maquina.BombaRefrigeracion;
import empguadalupe.ParoEmergencia.Maquina.DesaplicarFrenos;
import empguadalupe.ParoEmergencia.Maquina.JuntaInflable;
import empguadalupe.ParoEmergencia.Maquina.LubricacionForzadaOn;
import empguadalupe.ParoEmergencia.Maquina.ReguladorDesbloqueado;
import empguadalupe.ParoEmergencia.Maquina.ReguladorEnergizado;
import empguadalupe.ParoEmergencia.Maquina.ValvulaAislamiento;
import empguadalupe.ParoEmergencia.Maquina.VelocidadM90;
import empguadalupe.ParoEmergencia.Maquina.Velocidadm1;
import empguadalupe.ParoEmergencia.Maquina.Velocidadm10;
import empguadalupe.ParoEmergencia.Maquina.InterruptordeCampo;
import empguadalupe.ParoEmergencia.Maquina.LubricacionForzadaOff;
import empguadalupe.ParoEmergencia.Maquina.InterruptoGeneradorCerrado;
import empguadalupe.ParoEmergencia.Maquina.LimitadorApertura0;
import empguadalupe.ParoEmergencia.Maquina.PotenciaActivam5;
import empguadalupe.ParoEmergencia.Maquina.posiciondist0;
import empguadalupe.ParoEmergencia.Maquina.potenciaReactivam5;
 ...
 * @author lzambrs
 */
public class ParoEmergencia extends javax.swing.JFrame {
    Graphics g;          
...
//desactiva todos los botones macho
  ...
  public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ParoEmergencia().setVisible(true);
            }
        });
    }
