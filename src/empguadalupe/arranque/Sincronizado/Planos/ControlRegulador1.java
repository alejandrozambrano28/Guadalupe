 ...
 * @author lzambrs
 */
public class ControlRegulador1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControlRegulador1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
