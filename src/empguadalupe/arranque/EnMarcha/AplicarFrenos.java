...
public class AplicarFrenos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(361, 46, -1, -1));
        ...
        jTextArea1.setText("Su principal función es disminuir o anular progresivamente la velocidad de la maquina, o mantenerlo inmovilizado cuando está detenido.\nEn caso de tener que hacer un uso local, no se tendra un panel, se tendra que hacer un uso mecanico de las valvulas ubicadas cerca a el generador numero dos (Ver ubicación). este solo se aplica si la maquina se encuentra a una velocidad menor al 10%.");
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 880, 400));
