 ...
 * @author lzambrs
 */
public class SincroDisponible extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(SincroDisponible.class.getName()).log(Level.SEVERE, null, ex);
        }
	...
	{
		SincroDisponible p = new SincroDisponible();
		p.show();
