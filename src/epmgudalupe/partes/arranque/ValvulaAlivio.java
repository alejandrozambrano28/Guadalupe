...
import epmgudalupe.partes.Planos.PlanoValvulaAlivio;
import epmgudalupe.partes.condiciones.CondicionesValvulaAlivio;
...
public class ValvulaAlivio extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        CondicionesValvulaAlivio alivioc = null;
        try {
            alivioc = new CondicionesValvulaAlivio();
        } catch (IOException ex) {
            Logger.getLogger(ValvulaAlivio.class.getName()).log(Level.SEVERE, null, ex);
        }
                    alivioc.setSize(500,300);
                    alivioc.setVisible(true);        // TODO add your handling code here:
	...
	{
		ValvulaAlivio p = new ValvulaAlivio();
		p.show();
