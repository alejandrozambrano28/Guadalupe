...
import empguadalupe.ParoRapido.*;
import empguadalupe.ParoRapido.Maquina.CerrarValvulaEsferica;
import empguadalupe.ParoRapido.Maquina.AplicarFrenosParoRapido;
import empguadalupe.ParoRapido.Maquina.BombaRefrigeracion;
import empguadalupe.ParoRapido.Maquina.DesaplicarFrenos;
import empguadalupe.ParoRapido.Maquina.JuntaInflable;
import empguadalupe.ParoRapido.Maquina.LubricacionForzadaOn;
import empguadalupe.ParoRapido.Maquina.ReguladorDesbloqueado;
import empguadalupe.ParoRapido.Maquina.ReguladorEnergizado;
import empguadalupe.ParoRapido.Maquina.ValvulaAislamiento;
import empguadalupe.ParoRapido.Maquina.VelocidadM90;
import empguadalupe.ParoRapido.Maquina.Velocidadm1;
import empguadalupe.ParoRapido.Maquina.Velocidadm10;
import empguadalupe.ParoRapido.Maquina.InterruptordeCampo;
import empguadalupe.ParoRapido.Maquina.LubricacionForzadaOff;
import empguadalupe.ParoRapido.Maquina.InterruptoGeneradorCerrado;
import empguadalupe.ParoRapido.Maquina.LimitadorApertura0;
import empguadalupe.ParoRapido.Maquina.PotenciaActivam5;
import empguadalupe.ParoRapido.Maquina.posiciondist0;
import empguadalupe.ParoRapido.Maquina.potenciaReactivam5;
...
//calculo la posición del ratón y lo guardo en el p
    ...
    private void initComponents() {
        ...
        jLabel13.setBounds(370, 100, 70, 59);
        ...
        titulo.setText("SECUENCIA DE PARO RAPIDO UNIDAD X GUADALUPE IV");
        ...
        ParoRapido.setBounds(550, 60, 180, 23);
        ...
        jLabel15.setBounds(830, 630, 70, 59);
        ...
        jPanel1.add(icono);
        icono.setBounds(-20, -20, 1440, 840);
        ...
        if (superbande == true) {
            if (bande6 == true) {
                ...
                if ((tam[0] <= p.x && p.x <= tam[1]) && (tam[2] <= p.y && p.y <= tam[3]) && (contgeneral >= 4)) {
                    ...
                    boton6.setLocation(tam[0], tam[2] - 20);
                    System.out.println("correcto");
                    label6.setSize(boton6.getWidth(), boton6.getHeight());
                    label6.setLocation(tam[0], tam[2] - 20);
                    bande6 = false;
